...
#ifndef TIMED_TEXT_SSA_SOURCE_H_
#define TIMED_TEXT_SSA_SOURCE_H_
...
class TimedTextSSASource : public TimedTextSource {
public:
    TimedTextSSASource(const sp<MediaSource>& mediaSource); //For internal SP
    TimedTextSSASource(const sp<DataSource>& dataSource);       //For external SP
...
private:
    ...
    DISALLOW_EVIL_CONSTRUCTORS(TimedTextSSASource);
};

}  // namespace android

#endif  // TIMED_TEXT_SSA_SOURCE_H_
#endif
